    ...
    if ($_SESSION['username'] == 'adminlucey') {
        if ($_SERVER['REQUEST_METHOD'] == 'POST') {
            if (isset($_POST['add'])) {
                ...
                $sql = "SELECT `serviceName` from service WHERE `serviceName` = '" . $_POST['serviceName'] . "';";
                if ($manager->num_rows($manager->query($sql)) > 0) {
                    ?><script>alert("This service already added.")</script><?php
                } else {
                    $sql = "INSERT INTO `service`(`serviceName`, `costPerUnit`) VALUES ('" . $_POST['serviceName'] . "', '".$_POST['costPerUnit']."');";
        ...
        <div class="form-div">
            <form class="w3-container" method="post" action="AddService.php">
                <table>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="w3-input" type="text" name="serviceName"/>
                        </td>
                    </tr>
                    <tr>
                        <td>
                        ...
                        <td>
                            <input class="w3-input" type="text" name="costPerUnit"/>
                        </td>
                    </tr>
                    <tr>
                        <td colspan="2">
